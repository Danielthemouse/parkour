translations.he = {
	-- Error messages
	corrupt_map = "<r>מפה מושחתת. טוען אחרת.",
	corrupt_map_vanilla = "<r>[שגיאה] <n>לא ניתן להשיג מידע על המפה.",
	corrupt_map_mouse_start = "<r>[שגיאה] <n>על מפה זו להכיל נקודת התחלה (נקודת זימון העכברים).",
	corrupt_map_needing_chair = "<r>[שגיאה] <n>על המפה להכיל כיסא סיום.",
	corrupt_map_missing_checkpoints = "<r>[שגיאה] <n>על המפה להכיל נקודת שמירה (מסמר צהוב).",
	corrupt_data = "<r>לרוע המזל, נתוניך הושחתו ואופסו.",
	min_players = "<r>על מנת לשמור את נתוניך, חייבים להיות לפחות 4 שחקנים שונים בחדר. <bl>[%s/%s]",
	tribe_house = "<r>נתונים לא יישמרו בבית השבט.",
	invalid_syntax = "<r>תחביר לא תקין.",
	user_not_in_room = "<r>משתמש זה <n2>%s</n2> is לא נמצא בחדר.",
	arg_must_be_id = "<r>על טענה זו להיות מספר זהות תקין.",
	cant_update = "<r>לא ניתן לעדכן את דרגות השחקן כרגע. נסו שוב מאוחר יותר.",
	cant_edit = "<r>אתם לא יכולים לערוך את הדרגות של <n2>%s's</n2>.",
	invalid_rank = "<r>דרגה לא תקינה: <n2>%s",
	code_error = "<r>הופיעה שגיאה: <bl>%s-%s-%s %s",
	panic_mode = "<r>המודול נכנס למצב פאניקה.",
	public_panic = "<r>אנא חכו עד שמגיע בוט ויאתחל את המודול.",
	tribe_panic = "<r>אנא רשמו <n2>/module parkour</n2> על מנת לאתחל את המודול.",
	emergency_mode = "<r>מפעיל כיבוי חירום, לא מותרים שחקנים חדשים. אנא לכו לחדר #parkour אחר.",
	bot_requested = "<r>הבוט בוקש. הוא אמור להגיע עוד רגע.",
	stream_failure = "<r>שגיאת ערוץ הזרמה פנימית. אין אפשרות להעביר מידע.",
	maps_not_available = "מצב 'מפות' של<r>#parkour's זמין רק ב- <n2>*#parkour0maps</n2>.",
	version_mismatch = "<r>הגרסאות של בוט (<d>%s</d>) ולואה (<d>%s</d>) לא מתאימות. לא ניתן להתחיל את המערכת.",
	missing_bot = "<r>בוט חסר. חכו עד שהבוט יגיע או שדברו אל @Tocu#0018 בדיסקורד: <d>%s</d>",
	invalid_length = "<r>על הודעתך להכיל בין 10 ו- 100 תווים. היא מכילה <n2>%s</n2> תווים.",
	invalid_map = "<r>מפה לא תקינה.",
	map_does_not_exist = "<r>המפה הנתונה לא קיימת או לא ניתנת לטעינה. נסו שוב מאוחר יותר.",
	invalid_map_perm = "<r>המפה הנתונה היא לא P22 או P41.",
	invalid_map_perm_specific = "<r>המפה הנתונה היא לא ב- P%s.",
	cant_use_this_map = "<r>למה הנתונה ישנה בעיה קטנה והיא לא ניתנת לשימוש.",
	invalid_map_p41 = "<r>המפה הנתונה היא ב- P41, אך לא ברשימת מפות המודול.",
	invalid_map_p22 = "<r>המפה הנתונה היא ב- P22, אך היא ברשימת מפות המודול.",
	map_already_voting = "<r>למפה הנתונה כבר יש הצבעה פתוחה.",
	not_enough_permissions = "<r>אין לך מספיק הרשאות על מנת לעשות זאת.",
	...
	leaderboard_not_loaded = "<r>רשימת המובילים עוד לא נטענה. חכו רק רגע.",
	...
	rules = "חוקים",
	contribute = "תרומות",
	help_help = "<p align = 'center'><font size = '14'>ברוכים הבאים אל <T>#parkour!</T></font>\n\n<font size = '12'><J>המטרה שלכם היא להגיע על כל נקודות השמירה עד שאתם מסיימים את המפה.</J></font></p>\n\n<font size = '11'><N>• לחצו <O>O</O>, רשמו <O>!op</O> או לחצו על כפתור <O>ההגדרות</O> על מנת לפתוח את <T>תפריט ההגדרות</T>.\n• לחצו <O>P</O> או לחצו על סמל <O>היד</O> בצד שמאל-למעלה של המסך על מנת לפתוח את <T>תפריט הכוחות</T>.\n• לחצו <O>L</O> או רשמו <O>!lb</O> על מנת לפתוח את <T>רשימת המובילים</T>.\n• לחצו על מקש ה- <O>M</O> או <O>Delete</O> כדי לעשות <T>/mort</T>, ניתן להדליק ולכבות את הכפתורים ב- <J>תפריט ההגדרות</J>.\n• בכדי ללמוד עוד על <O>הצוות</O> <O>וחוקי הפארקור</O>, לחצו על תיקיות ה- <T>צוות</T> ו- <T>חוקים</T>.</font>\n\n<p align = 'center'><font size = '13'><T>התרומות עכשיו פתוחות! לפרטים נוספים, היכנסו אל תיקיית ה- <O>תרומות</O>!</T></font></p>",
